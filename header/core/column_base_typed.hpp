...
namespace CoGaDB {
    ...
    template<>
    inline bool ColumnBaseTyped<std::string>::add(const boost::any&) {
        return false;
    }
    ...
    template<>
    inline bool ColumnBaseTyped<std::string>::minus(const boost::any&) {
        return false;
    }
    ...
    template<>
    inline bool ColumnBaseTyped<std::string>::multiply(const boost::any&) {
        return false;
    }
    ...
    template<>
    inline bool ColumnBaseTyped<std::string>::division(const boost::any&) {
        return false;
    }
